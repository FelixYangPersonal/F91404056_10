...
public class F91404056_10 extends JApplet implements MouseListener,ActionListener
{
	...
	//存放經驗數
	private ImageIcon experience_image,experience_image2[] = new ImageIcon[4],
				experience_max_image,experience_max_image2[] = new ImageIcon[4];
	private JLabel experience_imagelabel,experience_imagelabel2[] = new JLabel[4],
				experience_max_imagelabel,experience_max_imagelabel2[] = new JLabel[4];

	//存放生命數
	private ImageIcon life_image,life_image2[] = new ImageIcon[4],
				life_max_image,life_max_image2[] = new ImageIcon[4];
	private JLabel life_imagelabel,life_imagelabel2[] = new JLabel[4],
				life_max_imagelabel,life_max_imagelabel2[] = new JLabel[4];

	//存放能力數
	private ImageIcon ability_image,ability_image2[] = new ImageIcon[4],
				ability_max_image,ability_max_image2[] = new ImageIcon[4];
	private JLabel ability_imagelabel,ability_imagelabel2[] = new JLabel[4],
				ability_max_imagelabel,ability_max_imagelabel2[] = new JLabel[4];
	...
	//存放計時器
	private ImageIcon tmh_image[] = new ImageIcon[2],tmm_image[] = new ImageIcon[2],
					tms_image[] = new ImageIcon[2];
	private JLabel tmh_imagelabel[] = new JLabel[2],tmm_imagelabel[] = new JLabel[2],
						tms_imagelabel[] = new JLabel[2];
	...
	public void init()
	{
		...
		{	
			...
			for(int i=0 ; i<4 ; i++)
			{
				...
				level_imagelabel2[i].setLocation(585-11*i-i,23);
			...
			if(level_length_int >= 2)
			{
				...
				for(int i=0 ; i<level_length_int ; i++)
				{
					...
					level_imagelabel.setLocation(585-11*(level_length_int-i-1)-i,23);
			...
			for(int i=0 ; i<4 ; i++)
			{
				...
				experience_imagelabel2[i].setLocation(524-11*i-i,63);
			...
			for(int i=0 ; i<4 ; i++)
			{
				...
				experience_max_imagelabel2[i].setLocation(549+11*i+i,103);
			...
			if(experience_length_int >= 2)
			{
				...
				for(int i=0 ; i<experience_length_int ; i++)
				{
					...
					experience_imagelabel.setLocation(524-11*(experience_length_int-i-1)-i,63);
			...
			if(experience_max_length_int >= 2)
			{
				...
				for(int i=0 ; i<experience_max_length_int ; i++)
				{
					...
					experience_max_imagelabel.setLocation(549+11*i+i,63);
			...
			for(int i=0 ; i<4 ; i++)
			{
				...
				life_imagelabel2[i].setLocation(524-11*i-i,103);
			...
			for(int i=0 ; i<4 ; i++)
			{
				...
				life_max_imagelabel2[i].setLocation(549+11*i+i,103);
			...
			if(life_length_int >= 2)
			{
				...
				for(int i=0 ; i<life_length_int ; i++)
				{
					...
					life_imagelabel.setLocation(524-11*(life_length_int-i-1)-i,103);
			...
			if(life_max_length_int >= 2)
			{
				...
				for(int i=0 ; i<life_max_length_int ; i++)
				{
					...
					life_max_imagelabel.setLocation(549+11*i+i,103);
			...
			for(int i=0 ; i<4 ; i++)
			{
				...
				ability_imagelabel2[i].setLocation(524-11*i-i,143);
				c.add(life_imagelabel2[i]);
			...
			for(int i=0 ; i<4 ; i++)
			{
				...
				ability_max_imagelabel2[i].setLocation(549+11*i+i,143);
			...
			if(ability_length_int >= 2)
			{
				...
				for(int i=0 ; i<ability_length_int ; i++)
				{
					...
					ability_imagelabel.setLocation(524-11*(ability_length_int-i-1)-i,143);
			...
			if(ability_max_length_int >= 2)
			{
				...
				for(int i=0 ; i<ability_max_length_int ; i++)
				{
					...
					ability_max_imagelabel.setLocation(549+11*i+i,143);
			...
			for(int i=0 ; i<4 ; i++)
			{
				...
				speed_imagelabel2[i].setLocation(549-11*i-i,143);
			...
			if(speed_length_int >= 2)
			{
				...
				for(int i=0 ; i<speed_length_int ; i++)
				{
					...
					speed_imagelabel.setLocation(585-11*(speed_length_int-i-1)-i,183);
			...
			for(int i=0 ; i<10 ; i++)
			{
				...
				kill_mouse_num_imagelabel2[i].setLocation(567-11*i-i,243);
			...
			if(kill_mouse_num_length_int >= 2)
			{
				...
				for(int i=0 ; i<kill_mouse_num_length_int ; i++)
				{
					...
					kill_mouse_num_imagelabel.setLocation(567-11*(kill_mouse_num_length_int-i-1)-i,243);
			...
			for(int i=0 ; i<2 ; i++)
			{
				...
				tmh_image[i] = new ImageIcon(); 
				tmh_imagelabel[i] = new JLabel(tmh_image[i]);
				tmh_imagelabel[i].setVisible(false);
				tmh_imagelabel[i].setSize(11,14);
				tmh_imagelabel[i].setLocation(495-11*i-i,293);
				c.add(tmh_imagelabel[i]);
			...
			for(int i=0 ; i<2 ; i++)
			{
				...
				tmm_image[i] = new ImageIcon(); 
				tmm_imagelabel[i] = new JLabel(tmm_image[i]);
				tmm_imagelabel[i].setVisible(false);
				tmm_imagelabel[i].setSize(11,14);
				tmm_imagelabel[i].setLocation(531-11*i-i,293);
				c.add(tmm_imagelabel[i]);
			...
			for(int i=0 ; i<2 ; i++)
			{
				...
				tms_image[i] = new ImageIcon(); 
				tms_imagelabel[i] = new JLabel(tms_image[i]);
				tms_imagelabel[i].setVisible(false);
				tms_imagelabel[i].setSize(11,14);
				tms_imagelabel[i].setLocation(567-11*i-i,293);
				c.add(tms_imagelabel[i]);
		...
		if(e.getSource() == tm[0])
		{
				...
				if(tmpsi%60 < 60)
				{
					...
					if(tms_length_int >= 2)
					{
						...
						for(int i=0 ; i<tms_length_int ; i++)
						{
							...
							tms_imagelabel[i].setVisible(true);
							tms_imagelabel[i].setIcon(new ImageIcon("./images/"+num_image[Integer.parseInt(tms_num)]+".png"));
							tms_imagelabel[i].setLocation(555+11*i+i,293);
			...
			if(m2 < 60 && tmpsi%60 == 0)
			{
				...
				if(tmpmi%60 < 60)
				{
 					...
 					//判斷計時器-分是否兩位數以上並設定一開始計時器-秒圖形與位置
					if(tmm_length_int >= 2)
					{
						...
						for(int i=0 ; i<tmm_length_int ; i++)
						{
							...
							tmm_num = M.substring(i,i+1);
							tmm_imagelabel[i].setVisible(true);
							tmm_imagelabel[i].setIcon(new ImageIcon("./images/"+num_image[Integer.parseInt(tmm_num)]+".png"));
							tmm_imagelabel[i].setLocation(519+11*i+i,293);
			...
			//判斷時顯示
			if(h2 < 24 && tmpmi%60 == 0 && tmpsi%60 == 0)
			{
				...
				if(tmphi%24 < 24)
				{
					...
					if(tmh_length_int >= 2)
					{
						...
						for(int i=0 ; i<tmh_length_int ; i++)
						{
							...
							tmh_num = H.substring(i,i+1);
							tmh_imagelabel[i].setVisible(true);
							tmh_imagelabel[i].setIcon(new ImageIcon("./images/"+num_image[Integer.parseInt(tmh_num)]+".png"));
							tmh_imagelabel[i].setLocation(483+11*i+i,293);
		...
		for(int j=0 ; j<5 ; j++)
		{
			...
			for(int i=0 ; i<5 ; i++)
			{
				...
				if(e.getSource() == appear_mouselabel[j][i] && e.getClickCount() == 1 && MOUSE_LEFT_PRESSED == true)
				{
					...
					if(experience != experience_max)
					{
						...
						if(experience_length_int >= 2)
						{
							...
							for(int k=0 ; k<experience_length_int ; k++)
							{
								...
								experience_imagelabel2[k].setLocation(524-11*(experience_length_int-k-1)-k,63);
					...
					else if(experience == experience_max)
					{
						...
						if(experience_max_length_int >= 2)
						{
							...
							for(int k=0 ; k<experience_max_length_int ; k++)
							{
								...
								experience_max_imagelabel2[k].setLocation(524+11*k+k,63);
						...
						if(level > 2)
						{
							...
							if(level_length_int >= 2)
							{
								...
								for(int k=0 ; k<level_length_int ; k++)
								{
									...
									level_imagelabel2[k].setLocation(524-11*(level_length_int-k-1)-k,103);
